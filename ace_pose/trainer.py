...
from ace_pose.utils import get_pixel_grid, to_homogeneous
from ace_pose.loss import ReproLoss
from ace_pose.network import Regressor
from ace_pose.schedule import ScheduleACE
from ace_pose.pose import PoseRefiner
        ...
        with torch.no_grad():
            ...
            while buffer_idx < self.options.max_training_buffer_size and dataset_passes < self.options.max_dataset_passes:
                ...
                for image_B1HW, image_mask_B1HW, pose_inv_B44, aug_pose_inv_B44, intrinsics_B33, intrinsics_inv_B33, target_crds_B3HW, _, idx_B in training_dataloader:
                    ...
                    # select patch based on reliability
                    image_mask_B1HW &=  heatmap_B1HW > self.options.patch_threshold
